...
import { AddRow, AddCard, AddNewCards, masterMenuItems, ladiesMenuItems, gentlementMenuItems, subLadiesMenuItems } from "../components/mockData";
...
/*
We will have another demo how to use TableComponent.
*/
